...
node dist/cli/index.js rules generate --target=Codex
```
...
├── rules/      # AGENTS.md/AGENTS.md/.codex marker-based merger
...
LLM provider: `src/curator/llm.ts` default Anthropic Haiku (`Codex-haiku-4-5-20251001`), env `ANTHROPIC_API_KEY`. Tests mock via msw.
